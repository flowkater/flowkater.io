...
tags: ["독서", "에세이", "릿미릿미"]
draft: false
keywords: ["돌파력", "명상록", "스토아 철학", "라이언 홀리데이", "마르쿠스 아우렐리우스", "자기계발", "회복"]
timezone: "Asia/Seoul"
---
...
홀리데이는 행동의 중요성을 거듭 강조한다. 세네카의 말을 인용하며 이렇게 말한다.
...
> "내일 할 거야"라는 말은 세상에서 가장 교활하고 유혹적인 거짓말이기 때문이다.

홀리데이는 미루기를 "가장 교활한 거짓말"이라고 표현한다. 내일은 오지 않는다. 오늘의 내일이 되면 또 다른 내일이 생길 뿐이다.

> 하나라도 온 마음을 다해 끝까지 해보지 않았다면, 아무것도 하지 않은 것과 다름이 없다.

> 제대로 살기 위해 무언가를 기다리지 마라. 인생은 그 사이에 지나가버린다.

결국 행동만이 현실을 바꾼다. 생각만으로는, 계획만으로는, 다짐만으로는 아무것도 달라지지 않는다. 홀리데이는 이렇게 덧붙인다.

> 살아남는 사람들이 살아남는 이유는 매일매일 해야 할 일을 제대로 처리하기 때문이다. 이것이 성공의 진짜 비밀이다.

> 노력하고, 찾고, 추구하되, 결코 포기하지 말라.

행동은 완벽할 필요가 없다. 다만 멈추지 않으면 된다.
