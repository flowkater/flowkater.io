...
timezone: "Asia/Seoul"
faq:
  - question: "개발 컨퍼런스에 참석하는 진짜 이유는?"
    answer: "발표는 유튜브로도 볼 수 있습니다. 컨퍼런스의 진짜 가치는 네트워킹입니다. 채용 기회, 다른 개발자들과의 기술 교류, 스몰 토크에서 시작되는 약한 연결고리가 기회로 발전하기도 합니다."
  - question: "Go에서 함수형 프로그래밍을 해야 하나요?"
    answer: "Effect 패턴처럼 Go 스타일 함수형을 시도할 수 있지만, 기존 DDD/클린 아키텍처로도 도메인 순수성과 인프라 분리가 충분하다면 굳이 복잡도를 키울 필요는 없습니다. 멀티 런타임 환경이나 이벤트 소싱 같은 복잡한 시스템에서 더 유용합니다."
  - question: "Go 개발자 채용이 어려운 이유는?"
    answer: "한국에서 Go는 상대적 소수 그룹입니다. 주변에 Go 개발자가 적기 때문에 컨퍼런스에서 네트워킹을 시도하거나, 허슬할 수 있는 주니어를 뽑아서 가르치는 것도 방법입니다."
---
