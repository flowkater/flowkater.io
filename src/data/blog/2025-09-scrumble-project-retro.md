...
description: "Scrumble 사이드 프로젝트에서 홈 오피스 협업 방식, 스펙 과잉과 데드라인 부재로 생긴 지연, LLM 연동·서드파티 통합 로드맵을 월별로 정리한 파트너십 회고."
...
draft: false
faq:
  - question: "집에서 사이드 프로젝트 하면서 가장 어려웠던 점은?"
    answer: "업무와 생활의 경계가 무너지는 것입니다. 처음에는 갓생 루틴(5시 30분 기상, 아침 운동)을 유지했지만, 프로젝트 막바지에는 새벽 4시 취침, 12시 기상으로 망가졌습니다. 장기적으로는 사무실이 필요합니다."
  - question: "ClickUp을 선택한 이유는?"
    answer: "Slack + Notion + Linear 기능을 하나의 툴에서 제공하면서 구독료는 1개 서비스 비용입니다. 각 서비스보다 10% 정도 부족하지만, 유기적으로 통합되어 있어 작은 팀에 적합합니다."
  - question: "Scrumble 프로젝트의 목표는?"
    answer: "우리 팀에서 쓸 수 있는 데일리 스크럼 서비스 MVP를 만들고, 본격적인 개발 프로젝트 전 업무 스킬과 협업 관점에서 적응하는 시간을 갖는 것이었습니다."
---
