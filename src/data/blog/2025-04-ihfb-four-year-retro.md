---
title: "4년간의 IHFB 회고"
description: "21년 파트타임으로 합류해 30명 규모의 R&D 본부를 세우고, 레거시를 걷어내며 신규 서비스를 만들고, 조직 문화를 실험하다가 결국 이별에 이르기까지 네 해를 타임라인으로 정리하며 배운 점과 후회를 촘촘히 남긴 장기 회고다. 채용, 기술 스택, 문화 실험의 분기별 변화를 빠짐없이 기록하고, 다시 시작할 사람에게 필요한 조언도 남겼으며, 개인적으로 남은 숙제도 솔직히 적었다."
