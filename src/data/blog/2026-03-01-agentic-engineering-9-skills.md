...
pubDatetime: 2026-03-01T14:00:00+09:00
tags: ["에세이", "AI코딩", "생산성"]
category: "essay"
featured: true
draft: false
references:
  ...
  - title: "Chris Lattner — The Claude C Compiler: What It Reveals About the Future of Software"
...
LLVM과 Swift를 만든 Chris Lattner도 같은 결론에 도달했다. Anthropic이 Claude Code로 C 컴파일러를 처음부터 끝까지 구현하는 프로젝트(CCC)를 공개했을 때, Lattner는 [블로그에서](https://www.modular.com/blog/the-claude-c-compiler-what-it-reveals-about-the-future-of-software) 이렇게 분석했다 — 구현은 교과서적이고 새로운 추상화는 없다. 강한 학부생 팀 수준이라고. 하지만 그가 진짜 주목한 건 다른 곳이었다. **"구현의 자동화가 일어날수록, 설계(Design)·판단(Judgment)·취향(Taste)의 중요성이 오히려 높아진다."** AI가 구현 장벽을 낮출수록, 뭘 만들지 결정하는 감각 — 그게 엔지니어의 핵심 역량이 된다는 거다.
