...
faq:
  - question: "조직에서 '승리'란 무엇인가요?"
    answer: "단순히 매출 목표 달성이나 IPO가 아닙니다. 본질적인 승리는 '조직원 전체가 결과에서 승리를 느끼는 것'입니다. 우리가 만든 제품이 고객의 삶을 변화시키고, 모두가 '우리가 해냈다'는 성취감을 공유하는 상태가 진짜 승리입니다."
  - question: "리더의 독단이 조직에 미치는 영향은?"
    answer: "리더가 모든 것을 결정하고 검토하는 순간, 조직의 지능은 리더 한 명의 지능으로 수렴합니다. 리더의 언변이 강할수록 팀원들은 비판적 사고를 멈추고, 잘못된 방향으로도 전력 질주하게 됩니다."
  - question: "팀원을 존중하면서도 승리하는 방법은?"
    answer: "친절함만으로는 부족합니다. 진정한 존중은 때로 아픈 진실을 말하는 용기를 필요로 합니다. 리더는 방향을 제시하되 과정은 자율을 주어야 합니다. 골대를 가리키는 건 리더의 몫이지만, 어떻게 돌파할지는 팀원의 몫입니다."
---
